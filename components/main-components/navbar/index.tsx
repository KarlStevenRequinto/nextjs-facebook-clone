...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {isSearchOpen && (
                <div
                    className={`absolute left-0 top-0 w-[320px] h-[500px] bg-white rounded-lg shadow-xl pl-2 pr-4 py-2 z-100 transform transition-transform duration-300 ease-in-out ${
                ...
                >
                    <div className="relative flex items-center pl-2">
                        <div
                            className={`w-[36px] h-[36px] rounded-full flex items-center justify-center hover:bg-[color:var(--comment-background)] cursor-pointer z-10 transition-transform duration-300 ease-in-out ${
