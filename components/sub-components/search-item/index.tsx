...
const SearchItem = () => {
    return (
        <div className="flex items-center justify-between bg-white rounded-lg px-3 py-2 hover:bg-[color:var(--comment-background)] transition-colors cursor-pointer w-full">
            {/* Left: Clock Icon */}
